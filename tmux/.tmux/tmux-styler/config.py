...
def main():
    styler = Styler()
    styler.current_command_max_depth = 2
    ...
    left_side = [
        Segment(SegmentType.FUNCTION, "session_name",
                HexColor("#8ba6bc"), Color256(234), style=Style(attrs=[TextAttributes.BOLD])),
    ]
    # Right side
    right_side = [
        Segment(SegmentType.FUNCTION, "cwd", HexColor("#6179a0"), Color256(
            233)),
